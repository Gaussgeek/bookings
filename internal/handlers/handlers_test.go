...
var theTests = []struct {
	...
	{"presSuite", "/presidential-suites/", "GET", http.StatusOK},
	{"platSuite", "/platinum-rooms/", "GET", http.StatusOK},
...
func TestRepository_PostReservation(t *testing.T) {
	...
	// test for an invalid start date
	postedData = url.Values{}
	...
	if rr.Code != http.StatusTemporaryRedirect {
		t.Errorf("PostReservation handler failed to insert reservation: got %d, wanted %d", rr.Code, http.StatusTemporaryRedirect)
	}
...
func TestRepository_AvailabilityJSON(t *testing.T) {
	...
	*****************************************/
	...
	err := json.Unmarshal([]byte(rr.Body.String()), &jres)
	if err != nil {
	...
	*****************************************/
	...
	// since we specified a start date < 2049-12-31, we expect availability
	if jres.OK || jres.Message != "Internal server error" {
	...
	*****************************************/
	...
	// since we specified a start date < 2049-12-31, we expect availability
	if jres.OK || jres.Message != "Error querying database" {
